...
public class GetFamilyServiceTest {
    ...
    public void pass() throws IOException, DataAccessException {
        ...
        Result r = gfs.getFamily(authTokenID);
        assertTrue(r instanceof GetFamilyResult);
        GetFamilyResult gr = (GetFamilyResult) r;

        //there are 31 people generated when we do a fill of 4 generations
        //confirm that that's the case here
        assertEquals(31,gr.getData().size());
    ...
    public void fail(){
        //invalid auth token
        Result r = gfs.getFamily("FAKE AUTH_TOKEN_ID!!!");
